...
BASE_DELAY = 1
AFTER_COOLDOWN = BASE_DELAY + 5 * GRAPH_FIELD + 10 * GRAPH_PLANT + 20 * GRAPH_ROT + 30 * GRAPH_SEED
...
FIELDS_NUMBER_BY_SIDE = 10 # размерность игрового поля в клетках (по одной стороне, так как поле квадратное)
